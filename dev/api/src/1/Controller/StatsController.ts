...
class StatsController extends Controller {
    ...
    protected initializeRoutes(): void {
        this.router.get("/top-three-products", requireAuth, this.handleAsync(this.getTopThreeProducts.bind(this)));
        this.router.get("/bottom-three-products", requireAuth, this.handleAsync(this.getBottomThreeProducts.bind(this)));
        this.router.get("/total-sales", requireAuth, this.handleAsync(this.getTotalSales.bind(this)));
    }
