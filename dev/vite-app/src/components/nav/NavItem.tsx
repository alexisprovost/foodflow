			...
			<li className="flex items-center justify-center mx-auto" onClick={onClick}>
				<div className="inline-block">
					{(notification || notification == 0) && (
						<span className="bg-white text-black w-5 h-5 text-xs flex items-center justify-center rounded-full absolute right-3 transform translate-x-1/2 -translate-y-1/2">{notification}</span>
					)}
					{icon}
				</div>
			</li>
