						...
						<div className="bg-white w-full max-w-md p-8 rounded-2xl shadow-md">
							...
							<div className="flex justify-center items-center mt-6">
								<div className="grid grid-rows-2 grid-flow-col gap-2">
									...
									<button type="button" className="text-white w-full  bg-[#7289DA] hover:bg-[#7289DA]/90 focus:ring-4 focus:outline-none focus:ring-[#7289DA]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#7289DA]/55 mr-2 mb-2">
									...
									<button type="button" className="text-white w-full  bg-[#1DA1F2] hover:bg-[#1DA1F2]/90 focus:ring-4 focus:outline-none focus:ring-[#1DA1F2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#1DA1F2]/55 mr-2 mb-2">
									...
									<button type="button" className="text-white w-full  bg-[#24292E] hover:bg-[#24292E]/90 focus:ring-4 focus:outline-none focus:ring-[#24292E]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#24292E]/55 mr-2 mb-2">
